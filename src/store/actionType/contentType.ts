...
//artcile rank
export const ARTICLES_RANK_REQUEST = 'ARTICLES_RANK_REQUEST';
export const ARTICLES_RANK_SUCCESS = 'ARTICLES_RANK_SUCCESS';
export const ARTICLES_RANK_FAILURE = 'ARTICLES_RANK_FAILURE';
